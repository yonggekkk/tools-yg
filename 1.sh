...
download_and_run_singbox() {
  ...
  if [ "$ARCH" == "arm" ] || [ "$ARCH" == "arm64" ] || [ "$ARCH" == "aarch64" ]; then
      ...
      FILE_INFO=("https://github.com/yonggekkk/tools-yg/raw/refs/heads/main/1/sbx web" "https://github.com/yonggekkk/tools-yg/raw/refs/heads/main/1/bot bot" "https://github.com/eooce/test/releases/download/freebsd/npm npm")
  else
